...
public final class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AndroidApplication.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AndroidApplication.getAppContext().getSystemService(WIFI_SERVICE);
        //noinspection ConstantConditions
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) AndroidApplication.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        //noinspection ConstantConditions
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AndroidApplication.getAppContext().getSystemService(Context.WIFI_SERVICE);
        //noinspection ConstantConditions
