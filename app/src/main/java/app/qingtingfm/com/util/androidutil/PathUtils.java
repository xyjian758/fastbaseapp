package app.qingtingfm.com.util.androidutil;
...
public class PathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return AndroidApplication.getAppContext().getApplicationInfo().dataDir;
        }
        return AndroidApplication.getAppContext().getDataDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return AndroidApplication.getAppContext().getApplicationInfo().dataDir + "/code_cache";
        }
        return AndroidApplication.getAppContext().getCodeCacheDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppCachePath() {
        return AndroidApplication.getAppContext().getCacheDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppDbsPath() {
        return AndroidApplication.getAppContext().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return AndroidApplication.getAppContext().getDatabasePath(name).getAbsolutePath();
    }
    ...
    public static String getInternalAppFilesPath() {
        return AndroidApplication.getAppContext().getFilesDir().getAbsolutePath();
    }
    ...
    public static String getInternalAppSpPath() {
        return AndroidApplication.getAppContext().getApplicationInfo().dataDir + "shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return AndroidApplication.getAppContext().getApplicationInfo().dataDir + "no_backup";
        }
        return AndroidApplication.getAppContext().getNoBackupFilesDir().getAbsolutePath();
    }
    ...
    public static String getExternalAppDataPath() {
        ...
        return AndroidApplication.getAppContext().getExternalCacheDir().getParentFile().getAbsolutePath();
    }
    ...
    public static String getExternalAppCachePath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalCacheDir().getAbsolutePath();
    }
    ...
    public static String getExternalAppFilesPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(null).getAbsolutePath();
    }
    ...
    public static String getExternalAppMusicPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_MUSIC).getAbsolutePath();
    }
    ...
    public static String getExternalAppPodcastsPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_PODCASTS).getAbsolutePath();
    }
    ...
    public static String getExternalAppRingtonesPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_RINGTONES).getAbsolutePath();
    }
    ...
    public static String getExternalAppAlarmsPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_ALARMS).getAbsolutePath();
    }
    ...
    public static String getExternalAppNotificationsPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS).getAbsolutePath();
    }
    ...
    public static String getExternalAppPicturesPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES).getAbsolutePath();
    }
    ...
    public static String getExternalAppMoviesPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_MOVIES).getAbsolutePath();
    }
    ...
    public static String getExternalAppDownloadPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath();
    }
    ...
    public static String getExternalAppDcimPath() {
        ...
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_DCIM).getAbsolutePath();
    }
    ...
    public static String getExternalAppDocumentsPath() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            //noinspection ConstantConditions
            return AndroidApplication.getAppContext().getExternalFilesDir(null).getAbsolutePath() + "/Documents";
        }
        //noinspection ConstantConditions
        return AndroidApplication.getAppContext().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS).getAbsolutePath();
    }
    ...
    public static String getExternalAppObbPath() {
        ...
        return AndroidApplication.getAppContext().getObbDir().getAbsolutePath();
    }
